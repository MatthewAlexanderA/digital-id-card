    ...
    <body class="bg-black font-sans">
        <div class="relative overflow-hidden">  
            <div class="bg-slate-100">
                <img src="{{ asset('assets/hero/agus.png') }}" alt="" class="rounded-sm">
            </div>
            ...
            <div class="absolute w-full">
                <div class="backdrop-blur-sm bg-white/10">
                    <div class="bg-gradient-to-l from-sky-500 to-indigo-500 text-white rounded-t-lg mx-8 -mt-96 p-3 z-10 h-96 px-10">
                        <h1 class="text-3xl font-extrabold mb-1 mt-2">Agus Hendrawan</h1>
                        <p class="text-xl mb-3">Direktur</p> 
                        <p class="text-xl font-semibold"><b>PT. Solusi Aplikasi Integrasi</b></p>

                        <p class="text-md mt-3"><i class="fa-solid fa-envelope"></i> <span class="ml-1">agus@solusiaplikasi.id</span></p>
                        <p class="text-md"><i class="fa-solid fa-phone"></i> +62 816 1330 045</p>
                        <form action="{{ route('add-to-contact') }}" method="POST">
                            @csrf
                            <input type="hidden" name="name" value="Agus Hendrawan">
                            <input type="hidden" name="company" value="PT. Solusi Aplikasi Integrasi">
                            <input type="hidden" name="job" value="Direktur">
                            <input type="hidden" name="email" value="agus@solusiaplikasi.id">
                            <input type="hidden" name="phone" value="+62 816 1330 045">
