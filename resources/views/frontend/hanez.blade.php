...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Hanez Rafael Hizekia</title>
    ...
    <body class="bg-black font-sans">
        <div class="relative overflow-hidden">  
            <div class="bg-slate-100">
                <img src="{{ asset('assets/hero/') }}" alt="" class="rounded-sm">
            </div>
            ...
            <div class="absolute w-full">
                <div class="backdrop-blur-sm bg-white/10">
                    <div class="bg-gradient-to-l from-sky-500 to-indigo-500 text-white rounded-t-lg mx-8 -mt-96 p-3 z-10 h-96 px-10">
                        <h1 class="text-3xl font-extrabold mb-1 mt-2">Hanez Rafael Hizekia</h1>
                        <p class="text-xl mb-3">Pre Sales</p> 
                        ...
                        <p class="text-md"><i class="fa-solid fa-phone"></i> +62 895 3839 18114</p>
                        <form action="{{ route('add-to-contact') }}" method="POST">
                            @csrf
                            <input type="hidden" name="name" value="Hanez Rafael Hizekia">
                            ...
                            <input type="hidden" name="phone" value="+62 895 3839 18114">
