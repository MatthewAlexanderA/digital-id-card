    ...
    <body class="bg-black font-sans">
        <div class="relative overflow-hidden">  
            <div class="bg-slate-100">
                <img src="{{ asset('assets/hero/ridho.png') }}" alt="" class="rounded-sm">
            </div>
            ...
            <div class="absolute w-full">
                <div class="backdrop-blur-sm bg-white/10">
                    <div class="bg-gradient-to-l from-sky-500 to-indigo-500 text-white rounded-t-lg mx-8 -mt-96 p-3 z-10 h-96 px-10">
                        <h1 class="text-3xl font-extrabold mb-1 mt-2">Ridho Ramadhan</h1>
                        <p class="text-xl mb-3">UI/UX Designer</p> 
                        <p class="text-xl font-semibold"><b>PT. Solusi Aplikasi Integrasi</b></p>

                        <p class="text-md mt-3"><i class="fa-solid fa-envelope"></i> <span class="ml-1">ridho@solusiaplikasi.id</span></p>
                        <p class="text-md"><i class="fa-solid fa-phone"></i> +62 895 3655 92886</p>
                        <form action="{{ route('add-to-contact') }}" method="POST">
                            @csrf
                            <input type="hidden" name="name" value="Ridho Ramadhan">
                            <input type="hidden" name="company" value="PT. Solusi Aplikasi Integrasi">
                            <input type="hidden" name="job" value="UI/UX Designer">
                            <input type="hidden" name="email" value="ridho@solusiaplikasi.id">
                            <input type="hidden" name="phone" value="+62 895 3655 92886">
